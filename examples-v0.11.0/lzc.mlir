...
^loop_continue:
    ...
    %3 = llhd.const 0 : i16
    %4 = llhd.dyn_extract_slice %in_tmp, %i.ld1 : (!llhd.sig<i16>, i32) -> !llhd.sig<i1>
    ...
    %9 = llhd.shr %in_i.prb, %3, %i.ld3 : (i16, i16, i32) -> i16
    ...
    %14 = llhd.const 1 : i32
    %15 = addi %i.ld4, %14 : i32
    llhd.store %i, %15 : !llhd.ptr<i32>
    br ^loop_body
}
...
llhd.proc @lfsr_16bit.param2.always_comb.1243.2(%en_i: !llhd.sig<i1>, %shift_q: !llhd.sig<i16>) -> (%out_o: !llhd.sig<i16> , %shift_d: !llhd.sig<i16> ) {
    br ^body
^body:
    %0 = llhd.const 0 : i1
...
llhd.proc @lfsr_16bit.param2.always_ff.1284.2(%clk_i: !llhd.sig<i1>, %rst_ni: !llhd.sig<i1>, %shift_d: !llhd.sig<i16>) -> (%shift_q: !llhd.sig<i16> ) {
    br ^init
^init:
...
llhd.proc @lfsr_16bit.param2.initial.1302.2() -> () {
    br ^0
^0:
    llhd.halt
}

llhd.entity @lfsr_16bit.param2(%clk_i: !llhd.sig<i1>, %rst_ni: !llhd.sig<i1>, %en_i: !llhd.sig<i1>) -> (%out_o: !llhd.sig<i16> ) {
    %0 = llhd.const 0 : i16
    %shift_d = llhd.sig "shift_d" %0 : i16
    %shift_q = llhd.sig "shift_q" %0 : i16
    llhd.inst "inst" @lfsr_16bit.param2.always_comb.1243.2(%en_i, %shift_q) -> (%out_o, %shift_d) : (!llhd.sig<i1>, !llhd.sig<i16>) -> (!llhd.sig<i16>, !llhd.sig<i16>)
    llhd.inst "inst1" @lfsr_16bit.param2.always_ff.1284.2(%clk_i, %rst_ni, %shift_d) -> (%shift_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i16>) -> (!llhd.sig<i16>)
    llhd.inst "inst2" @lfsr_16bit.param2.initial.1302.2() -> () : () -> ()
}
...
llhd.entity @lzc_tb() -> () {
    ...
    llhd.inst "inst" @lzc.param1(%in_i) -> (%cnt_o, %empty_o) : (!llhd.sig<i16>) -> (!llhd.sig<i4>, !llhd.sig<i1>)
    %4 = llhd.sig "4" %2 : i1
    %5 = llhd.const #llhd.time<0s, 1d, 0e> : !llhd.time
    llhd.drv %4, %3 after %5 : !llhd.sig<i1>
    llhd.inst "inst1" @lfsr_16bit.param2(%clk_i, %rst_ni, %4) -> (%in_i) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>) -> (!llhd.sig<i16>)
