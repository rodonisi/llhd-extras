...
^loop_continue:
    ...
    llhd.drv %clk_i, %7 after %13 : !llhd.sig<i1>
    %14 = llhd.const 0 : i1
...
^16:
    ...
    llhd.store %loop_count, %17 : !llhd.ptr<i32>
    br ^loop_body
}
...
llhd.entity @lfsr_16bit_tb() -> () {
    ...
    llhd.inst "inst" @lfsr_16bit.param1(%clk_i, %rst_ni, %en_i) -> (%out_o) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>) -> (!llhd.sig<i16>)
