...
llhd.entity @graycode.param1(%A: !llhd.sig<i20>) -> (%G: !llhd.sig<i20> , %Z: !llhd.sig<i20> ) {
    llhd.inst "inst" @binary_to_gray.param2(%A) -> (%G) : (!llhd.sig<i20>) -> (!llhd.sig<i20>)
    llhd.inst "inst1" @gray_to_binary.param3(%G) -> (%Z) : (!llhd.sig<i20>) -> (!llhd.sig<i20>)
}
...
^loop_body1:
    %8 = llhd.const 0 : i32
    %i.ld3 = llhd.load %i : !llhd.ptr<i21>
    %zext1 = llhd.insert_slice %8, %i.ld3, 0 : i32, i21
    %9 = llhd.const 1048576 : i32
    %10 = cmpi "ult", %zext1, %9 : i32
    cond_br %10, ^loop_continue2, ^loop_exit2
^loop_body2:
    %11 = llhd.const 0 : i32
    %i.ld = llhd.load %i : !llhd.ptr<i21>
    %zext = llhd.insert_slice %11, %i.ld, 0 : i32, i21
    %12 = llhd.const 1048576 : i32
...
^loop_exit1:
    ...
    br ^loop_body
^loop_continue1:
    %i.ld1 = llhd.load %i : !llhd.ptr<i21>
    %15 = llhd.extract_slice %i.ld1, 0 : i21 -> i20
...
^18:
    ...
    %i.ld2 = llhd.load %i : !llhd.ptr<i21>
    %19 = llhd.const 1 : i21
    %20 = addi %i.ld2, %19 : i21
    llhd.store %i, %20 : !llhd.ptr<i21>
    br ^loop_body2
^loop_exit2:
    llhd.halt
^loop_continue2:
    %i.ld4 = llhd.load %i : !llhd.ptr<i21>
    %zext2 = llhd.insert_slice %8, %i.ld4, 0 : i32, i21
    %21 = subi %9, %zext2 : i32
    %22 = llhd.const 1 : i32
    %23 = subi %21, %22 : i32
...
^27:
    ...
    llhd.drv %bp, %b.prb1 after %25 : !llhd.sig<i20>
    %i.ld5 = llhd.load %i : !llhd.ptr<i21>
    %28 = llhd.const 1 : i21
    %29 = addi %i.ld5, %28 : i21
...
llhd.entity @graycode_tb() -> () {
    ...
    llhd.inst "inst" @graycode.param1(%a) -> (%b, %c) : (!llhd.sig<i20>) -> (!llhd.sig<i20>, !llhd.sig<i20>)
