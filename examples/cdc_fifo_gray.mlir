llhd.entity @binary_to_gray.param2(%A: !llhd.sig<i4>) -> (%Z: !llhd.sig<i4> ) {
    ...
    %0 = llhd.extract_slice %A1, 1 : i4 -> i3
    %1 = llhd.const 0 : i4
...
llhd.entity @gray_to_binary.param4(%A: !llhd.sig<i4>) -> (%Z: !llhd.sig<i4> ) {
    ...
    %A1 = llhd.prb %A : !llhd.sig<i4>
    %1 = llhd.extract_slice %A1, 0 : i4 -> i1
    %2 = llhd.extract_slice %A1, 1 : i4 -> i1
    %3 = llhd.xor %1, %2 : i1
    %4 = llhd.extract_slice %A1, 2 : i4 -> i1
    %5 = llhd.xor %3, %4 : i1
    %6 = llhd.extract_slice %A1, 3 : i4 -> i1
    %7 = llhd.xor %5, %6 : i1
    ...
    %14 = llhd.extract_slice %A1, 1 : i4 -> i3
    ...
    %26 = llhd.extract_slice %A1, 2 : i4 -> i2
...
^if_false:
    ...
    %12 = llhd.insert_slice %8, %fifo_widx1, 0 : i32, i3
    %13 = cmpi "eq", %12, %8 : i32
    %14 = cmpi "ne", %13, %0 : i1
...
llhd.proc @cdc_fifo_gray.param1.always_ff.265.14(%fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>, %src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^init
^init:
    %src_clk_i1 = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni1 = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
^if_false:
    ...
    cond_br %16, ^if_true1, ^init
^if_true:
    %17 = llhd.array_uniform %8 : !llhd.array<8xi32>
    %18 = llhd.dyn_extract_element %fifo_data_q, %9 : (!llhd.sig<!llhd.array<8xi32>>, i32) -> !llhd.sig<i32>
    llhd.drv %18, %8 after %10 : !llhd.sig<i32>
    br ^init
^if_true1:
    %19 = llhd.array_uniform %8 : !llhd.array<8xi32>
    %20 = llhd.dyn_extract_element %fifo_data_q, %9 : (!llhd.sig<!llhd.array<8xi32>>, i32) -> !llhd.sig<i32>
    %fifo_wdata1 = llhd.prb %fifo_wdata : !llhd.sig<i32>
    llhd.drv %20, %fifo_wdata1 after %10 : !llhd.sig<i32>
    br ^init
}

llhd.proc @cdc_fifo_gray.param1.always_ff.265.15(%fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>, %src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^init
^init:
    %src_clk_i1 = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni1 = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
llhd.proc @cdc_fifo_gray.param1.always_ff.265.16(%fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>, %src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^init
^init:
    %src_clk_i1 = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni1 = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
llhd.proc @cdc_fifo_gray.param1.always_ff.265.17(%fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>, %src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^init
^init:
    %src_clk_i1 = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni1 = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
llhd.proc @cdc_fifo_gray.param1.always_ff.265.18(%fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>, %src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^init
^init:
    %src_clk_i1 = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni1 = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
llhd.proc @cdc_fifo_gray.param1.always_ff.265.19(%fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>, %src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^init
^init:
    %src_clk_i1 = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni1 = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
llhd.proc @cdc_fifo_gray.param1.always_ff.265.20(%fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>, %src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^init
^init:
    %src_clk_i1 = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni1 = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
llhd.entity @cdc_fifo_gray.param1(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %src_data_i: !llhd.sig<i32>, %src_valid_i: !llhd.sig<i1>, %dst_rst_ni: !llhd.sig<i1>, %dst_clk_i: !llhd.sig<i1>, %dst_ready_i: !llhd.sig<i1>) -> (%src_ready_o: !llhd.sig<i1> , %dst_data_o: !llhd.sig<i32> , %dst_valid_o: !llhd.sig<i1> ) {
    ...
    %fifo_data_q = llhd.sig "sig5" %3 : !llhd.array<8xi32>
    %4 = llhd.const 0 : i4
    ...
    // %6 = llhd.shr %fifo_data_q1, %5, %fifo_ridx1 : (!llhd.array<8xi32>, !llhd.array<8xi32>, i3) -> !llhd.array<8xi32>
    // %7 = llhd.extract_element %6, 0 : !llhd.array<8xi32> -> i32
    %7 = llhd.dyn_extract_element %fifo_data_q1, %fifo_ridx1 : (!llhd.array<8xi32>, i3) -> i32
    %8 = llhd.const #llhd.time<0s, 0d, 1e> : !llhd.time
    llhd.drv %fifo_rdata, %7 after %8 : !llhd.sig<i32>
    %src_wptr_bin_q1 = llhd.prb %src_wptr_bin_q : !llhd.sig<i4>
    %9 = llhd.insert_slice %2, %src_wptr_bin_q1, 0 : i32, i4
    %10 = llhd.const 1 : i32
    %11 = addi %9, %10 : i32
    ...
    %13 = llhd.insert_slice %2, %dst_rptr_bin_q1, 0 : i32, i4
    %14 = addi %13, %10 : i32
    %15 = llhd.extract_slice %14, 0 : i32 -> i4
    ...
    %21 = llhd.extract_slice %src_wptr_bin_q1, 0 : i4 -> i3
    ...
    %25 = llhd.extract_slice %dst_rptr_bin_q1, 0 : i4 -> i3
    ...
    llhd.inst "inst4" @cdc_fifo_gray.param1.always_ff.265.1(%fifo_widx, %fifo_write, %fifo_wdata, %src_rst_ni, %src_clk_i) -> (%fifo_data_q) : (!llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>, !llhd.sig<i1>, !llhd.sig<i1>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst5" @cdc_fifo_gray.param1.always_ff.265.14(%fifo_widx, %fifo_write, %fifo_wdata, %src_rst_ni, %src_clk_i) -> (%fifo_data_q) : (!llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>, !llhd.sig<i1>, !llhd.sig<i1>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst6" @cdc_fifo_gray.param1.always_ff.265.15(%fifo_widx, %fifo_write, %fifo_wdata, %src_rst_ni, %src_clk_i) -> (%fifo_data_q) : (!llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>, !llhd.sig<i1>, !llhd.sig<i1>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst7" @cdc_fifo_gray.param1.always_ff.265.16(%fifo_widx, %fifo_write, %fifo_wdata, %src_rst_ni, %src_clk_i) -> (%fifo_data_q) : (!llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>, !llhd.sig<i1>, !llhd.sig<i1>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst8" @cdc_fifo_gray.param1.always_ff.265.17(%fifo_widx, %fifo_write, %fifo_wdata, %src_rst_ni, %src_clk_i) -> (%fifo_data_q) : (!llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>, !llhd.sig<i1>, !llhd.sig<i1>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst9" @cdc_fifo_gray.param1.always_ff.265.18(%fifo_widx, %fifo_write, %fifo_wdata, %src_rst_ni, %src_clk_i) -> (%fifo_data_q) : (!llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>, !llhd.sig<i1>, !llhd.sig<i1>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst10" @cdc_fifo_gray.param1.always_ff.265.19(%fifo_widx, %fifo_write, %fifo_wdata, %src_rst_ni, %src_clk_i) -> (%fifo_data_q) : (!llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>, !llhd.sig<i1>, !llhd.sig<i1>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst11" @cdc_fifo_gray.param1.always_ff.265.20(%fifo_widx, %fifo_write, %fifo_wdata, %src_rst_ni, %src_clk_i) -> (%fifo_data_q) : (!llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>, !llhd.sig<i1>, !llhd.sig<i1>) -> (!llhd.sig<!llhd.array<8xi32>>)
...
^loop_exit1:
    ...
    %28 = llhd.insert_slice %26, %27, 0 : i32, i1
