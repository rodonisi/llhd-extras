...
llhd.entity @gray_to_binary.param4(%A: !llhd.sig<i4>) -> (%Z: !llhd.sig<i4> ) {
    ...
    // %56 = llhd.const 0 : i4
    // %57 = llhd.const #llhd.time<0s, 0d, 0e> : !llhd.time
    // llhd.drv %Z, %56 after %57 : !llhd.sig<i4>
}
...
llhd.proc @cdc_fifo_gray.param1.always_ff.384.1(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^0
^0:
    br ^init
^init:
...
llhd.proc @cdc_fifo_gray.param1.always_ff.384.14(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^0
^0:
    br ^init
^init:
...
llhd.proc @cdc_fifo_gray.param1.always_ff.384.15(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^0
^0:
    br ^init
^init:
...
llhd.proc @cdc_fifo_gray.param1.always_ff.384.16(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^0
^0:
    br ^init
^init:
...
llhd.proc @cdc_fifo_gray.param1.always_ff.384.17(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^0
^0:
    br ^init
^init:
...
llhd.proc @cdc_fifo_gray.param1.always_ff.384.18(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^0
^0:
    br ^init
^init:
...
llhd.proc @cdc_fifo_gray.param1.always_ff.384.19(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^0
^0:
    br ^init
^init:
...
llhd.proc @cdc_fifo_gray.param1.always_ff.384.20(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<8xi32>> ) {
    br ^0
^0:
    br ^init
^init:
...
llhd.proc @cdc_fifo_gray.param1.initial.283.1() -> () {
    br ^0
^0:
    llhd.halt
}

llhd.proc @cdc_fifo_gray.param1.always_ff.317.1(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %src_valid_i: !llhd.sig<i1>, %src_ready_o: !llhd.sig<i1>, %src_wptr_bin_d: !llhd.sig<i4>, %src_wptr_gray_d: !llhd.sig<i4>) -> (%src_wptr_bin_q: !llhd.sig<i4> , %src_wptr_gray_q: !llhd.sig<i4> ) {
    br ^0
^0:
    br ^init
^init:
...
llhd.proc @cdc_fifo_gray.param1.always_ff.318.1(%dst_rst_ni: !llhd.sig<i1>, %dst_clk_i: !llhd.sig<i1>, %dst_valid_o: !llhd.sig<i1>, %dst_ready_i: !llhd.sig<i1>, %dst_rptr_bin_d: !llhd.sig<i4>, %dst_rptr_gray_d: !llhd.sig<i4>) -> (%dst_rptr_bin_q: !llhd.sig<i4> , %dst_rptr_gray_q: !llhd.sig<i4> ) {
    br ^0
^0:
    br ^init
^init:
...
llhd.proc @cdc_fifo_gray.param1.always_ff.325.1(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %dst_rptr_gray_q: !llhd.sig<i4>, %src_rptr_gray_q: !llhd.sig<i4>) -> (%src_rptr_gray_q1: !llhd.sig<i4> , %src_rptr_gray_q2: !llhd.sig<i4> ) {
    br ^0
^0:
...
llhd.proc @cdc_fifo_gray.param1.always_ff.326.1(%dst_rst_ni: !llhd.sig<i1>, %dst_clk_i: !llhd.sig<i1>, %src_wptr_gray_q: !llhd.sig<i4>, %dst_wptr_gray_q: !llhd.sig<i4>) -> (%dst_wptr_gray_q1: !llhd.sig<i4> , %dst_wptr_gray_q2: !llhd.sig<i4> ) {
    br ^0
^0:
...
llhd.entity @cdc_fifo_gray.param1(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %src_data_i: !llhd.sig<i32>, %src_valid_i: !llhd.sig<i1>, %dst_rst_ni: !llhd.sig<i1>, %dst_clk_i: !llhd.sig<i1>, %dst_ready_i: !llhd.sig<i1>) -> (%src_ready_o: !llhd.sig<i1> , %dst_data_o: !llhd.sig<i32> , %dst_valid_o: !llhd.sig<i1> ) {
    ...
    %1 = llhd.const 0 : i3
    %fifo_ridx = llhd.sig "fifo_ridx" %1 : i3
    %2 = llhd.const 0 : i1
    %fifo_write = llhd.sig "fifo_write" %2 : i1
    %3 = llhd.const 0 : i32
    %fifo_wdata = llhd.sig "fifo_wdata" %3 : i32
    %4 = llhd.const 0 : i32
    %fifo_rdata = llhd.sig "fifo_rdata" %4 : i32
    %5 = llhd.const 0 : i32
    %6 = llhd.const 0 : i32
    %7 = llhd.const 0 : i32
    %8 = llhd.const 0 : i32
    ...
    %fifo_data_q = llhd.sig "fifo_data_q" %13 : !llhd.array<8xi32>
    %14 = llhd.const 0 : i4
    %src_wptr_bin_q = llhd.sig "src_wptr_bin_q" %14 : i4
    %15 = llhd.const 0 : i4
    %src_wptr_gray_q = llhd.sig "src_wptr_gray_q" %15 : i4
    %16 = llhd.const 0 : i4
    %dst_rptr_bin_q = llhd.sig "dst_rptr_bin_q" %16 : i4
    %17 = llhd.const 0 : i4
    %dst_rptr_gray_q = llhd.sig "dst_rptr_gray_q" %17 : i4
    %18 = llhd.const 0 : i4
    %src_wptr_bin_d = llhd.sig "src_wptr_bin_d" %18 : i4
    %19 = llhd.const 0 : i4
    %src_wptr_gray_d = llhd.sig "src_wptr_gray_d" %19 : i4
    %20 = llhd.const 0 : i4
    %dst_rptr_bin_d = llhd.sig "dst_rptr_bin_d" %20 : i4
    %21 = llhd.const 0 : i4
    %dst_rptr_gray_d = llhd.sig "dst_rptr_gray_d" %21 : i4
    %22 = llhd.const 0 : i4
    %src_rptr_gray_q = llhd.sig "src_rptr_gray_q" %22 : i4
    %23 = llhd.const 0 : i4
    %src_rptr_gray_q2 = llhd.sig "src_rptr_gray_q2" %23 : i4
    %24 = llhd.const 0 : i4
    %dst_wptr_gray_q = llhd.sig "dst_wptr_gray_q" %24 : i4
    %25 = llhd.const 0 : i4
    %dst_wptr_gray_q2 = llhd.sig "dst_wptr_gray_q2" %25 : i4
    %26 = llhd.const 0 : i4
    %src_rptr_bin = llhd.sig "src_rptr_bin" %26 : i4
    %27 = llhd.const 0 : i4
    %dst_wptr_bin = llhd.sig "dst_wptr_bin" %27 : i4
    ...
    llhd.inst "inst4" @cdc_fifo_gray.param1.always_ff.384.1(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst5" @cdc_fifo_gray.param1.always_ff.384.14(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst6" @cdc_fifo_gray.param1.always_ff.384.15(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst7" @cdc_fifo_gray.param1.always_ff.384.16(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst8" @cdc_fifo_gray.param1.always_ff.384.17(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst9" @cdc_fifo_gray.param1.always_ff.384.18(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst10" @cdc_fifo_gray.param1.always_ff.384.19(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst11" @cdc_fifo_gray.param1.always_ff.384.20(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<8xi32>>)
    llhd.inst "inst12" @cdc_fifo_gray.param1.initial.283.1() -> () : () -> ()
    llhd.inst "inst13" @cdc_fifo_gray.param1.always_ff.317.1(%src_rst_ni, %src_clk_i, %src_valid_i, %src_ready_o, %src_wptr_bin_d, %src_wptr_gray_d) -> (%src_wptr_bin_q, %src_wptr_gray_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i4>, !llhd.sig<i4>) -> (!llhd.sig<i4>, !llhd.sig<i4>)
    llhd.inst "inst14" @cdc_fifo_gray.param1.always_ff.318.1(%dst_rst_ni, %dst_clk_i, %dst_valid_o, %dst_ready_i, %dst_rptr_bin_d, %dst_rptr_gray_d) -> (%dst_rptr_bin_q, %dst_rptr_gray_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i4>, !llhd.sig<i4>) -> (!llhd.sig<i4>, !llhd.sig<i4>)
    llhd.inst "inst15" @cdc_fifo_gray.param1.always_ff.325.1(%src_rst_ni, %src_clk_i, %dst_rptr_gray_q, %src_rptr_gray_q) -> (%src_rptr_gray_q, %src_rptr_gray_q2) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i4>, !llhd.sig<i4>) -> (!llhd.sig<i4>, !llhd.sig<i4>)
    llhd.inst "inst16" @cdc_fifo_gray.param1.always_ff.326.1(%dst_rst_ni, %dst_clk_i, %src_wptr_gray_q, %dst_wptr_gray_q) -> (%dst_wptr_gray_q, %dst_wptr_gray_q2) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i4>, !llhd.sig<i4>) -> (!llhd.sig<i4>, !llhd.sig<i4>)
}
