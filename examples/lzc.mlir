...
^loop_continue:
    %3 = llhd.const 0 : i16
    %4 = llhd.dyn_extract_slice %in_tmp, %i : (!llhd.sig<i16>, i32) -> !llhd.sig<i1>
...
llhd.entity @lzc.param1(%in_i: !llhd.sig<i16>) -> (%cnt_o: !llhd.sig<i4> , %empty_o: !llhd.sig<i1> ) {
    ...
    %7 = llhd.extract_slice %sel_nodes1, 0 : i16 -> i1
    %8 = llhd.not %7 : i1
    %in_i1 = llhd.prb %in_i : !llhd.sig<i16>
    %9 = llhd.extract_slice %in_i1, 0 : i16 -> i1
    %10 = llhd.extract_slice %in_i1, 1 : i16 -> i1
    %11 = llhd.or %9, %10 : i1
    %12 = llhd.extract_slice %in_i1, 2 : i16 -> i1
    %13 = llhd.or %11, %12 : i1
    %14 = llhd.extract_slice %in_i1, 3 : i16 -> i1
    %15 = llhd.or %13, %14 : i1
    %16 = llhd.extract_slice %in_i1, 4 : i16 -> i1
    %17 = llhd.or %15, %16 : i1
    %18 = llhd.extract_slice %in_i1, 5 : i16 -> i1
    %19 = llhd.or %17, %18 : i1
    %20 = llhd.extract_slice %in_i1, 6 : i16 -> i1
    %21 = llhd.or %19, %20 : i1
    %22 = llhd.extract_slice %in_i1, 7 : i16 -> i1
    %23 = llhd.or %21, %22 : i1
    %24 = llhd.extract_slice %in_i1, 8 : i16 -> i1
    %25 = llhd.or %23, %24 : i1
    %26 = llhd.extract_slice %in_i1, 9 : i16 -> i1
    %27 = llhd.or %25, %26 : i1
    %28 = llhd.extract_slice %in_i1, 10 : i16 -> i1
    %29 = llhd.or %27, %28 : i1
    %30 = llhd.extract_slice %in_i1, 11 : i16 -> i1
    %31 = llhd.or %29, %30 : i1
    %32 = llhd.extract_slice %in_i1, 12 : i16 -> i1
    %33 = llhd.or %31, %32 : i1
    %34 = llhd.extract_slice %in_i1, 13 : i16 -> i1
    %35 = llhd.or %33, %34 : i1
    %36 = llhd.extract_slice %in_i1, 14 : i16 -> i1
    %37 = llhd.or %35, %36 : i1
    %38 = llhd.extract_slice %in_i1, 15 : i16 -> i1
    %39 = llhd.or %37, %38 : i1
    %40 = llhd.not %39 : i1
    ...
    %46 = llhd.sig "sig4" %45 : !llhd.array<16xi4>
    ...
    %50 = llhd.const 2 : i32
    %51 = llhd.sig "sig5" %45 : !llhd.array<16xi4>
    ...
    %55 = llhd.const 3 : i32
    %56 = llhd.sig "sig6" %45 : !llhd.array<16xi4>
    ...
    %60 = llhd.const 4 : i32
    %61 = llhd.sig "sig7" %45 : !llhd.array<16xi4>
    ...
    %65 = llhd.const 5 : i32
    %66 = llhd.sig "sig8" %45 : !llhd.array<16xi4>
    ...
    %70 = llhd.const 6 : i32
    %71 = llhd.sig "sig9" %45 : !llhd.array<16xi4>
    ...
    %75 = llhd.const 7 : i32
    %76 = llhd.sig "sig10" %45 : !llhd.array<16xi4>
    ...
    %80 = llhd.const 8 : i32
    %81 = llhd.sig "sig11" %45 : !llhd.array<16xi4>
    ...
    %85 = llhd.const 9 : i32
    %86 = llhd.sig "sig12" %45 : !llhd.array<16xi4>
    ...
    %91 = llhd.sig "sig13" %45 : !llhd.array<16xi4>
    ...
    %96 = llhd.sig "sig14" %45 : !llhd.array<16xi4>
    ...
    %101 = llhd.sig "sig15" %45 : !llhd.array<16xi4>
    ...
    %106 = llhd.sig "sig16" %45 : !llhd.array<16xi4>
    ...
    %111 = llhd.sig "sig17" %45 : !llhd.array<16xi4>
    ...
    %116 = llhd.sig "sig18" %45 : !llhd.array<16xi4>
    ...
    %121 = llhd.extract_slice %sel_nodes1, 1 : i16 -> i15
    %122 = llhd.insert_slice %2, %121, 0 : i16, i15
    %123 = llhd.extract_slice %122, 0 : i16 -> i1
    %124 = llhd.extract_slice %sel_nodes1, 2 : i16 -> i14
    ...
    %134 = llhd.extract_slice %index_nodes1, 1 : !llhd.array<16xi4> -> !llhd.array<15xi4>
    ...
    %139 = llhd.extract_slice %index_nodes1, 2 : !llhd.array<16xi4> -> !llhd.array<14xi4>
    ...
    %148 = llhd.extract_slice %sel_nodes1, 3 : i16 -> i13
    %149 = llhd.insert_slice %2, %148, 0 : i16, i13
    %150 = llhd.extract_slice %149, 0 : i16 -> i1
    %151 = llhd.extract_slice %sel_nodes1, 4 : i16 -> i12
    ...
    %155 = llhd.sig "sig20" %45 : !llhd.array<16xi4>
    ...
    %161 = llhd.extract_slice %index_nodes1, 3 : !llhd.array<16xi4> -> !llhd.array<13xi4>
    ...
    %166 = llhd.extract_slice %index_nodes1, 4 : !llhd.array<16xi4> -> !llhd.array<12xi4>
    ...
    %175 = llhd.extract_slice %sel_nodes1, 5 : i16 -> i11
    %176 = llhd.insert_slice %2, %175, 0 : i16, i11
    %177 = llhd.extract_slice %176, 0 : i16 -> i1
    %178 = llhd.extract_slice %sel_nodes1, 6 : i16 -> i10
    ...
    %182 = llhd.sig "sig22" %45 : !llhd.array<16xi4>
    ...
    %188 = llhd.extract_slice %index_nodes1, 5 : !llhd.array<16xi4> -> !llhd.array<11xi4>
    ...
    %193 = llhd.extract_slice %index_nodes1, 6 : !llhd.array<16xi4> -> !llhd.array<10xi4>
    ...
    %202 = llhd.extract_slice %sel_nodes1, 7 : i16 -> i9
    %203 = llhd.insert_slice %2, %202, 0 : i16, i9
    %204 = llhd.extract_slice %203, 0 : i16 -> i1
    %205 = llhd.extract_slice %sel_nodes1, 8 : i16 -> i8
    ...
    %209 = llhd.sig "sig24" %45 : !llhd.array<16xi4>
    ...
    %215 = llhd.extract_slice %index_nodes1, 7 : !llhd.array<16xi4> -> !llhd.array<9xi4>
    ...
    %220 = llhd.extract_slice %index_nodes1, 8 : !llhd.array<16xi4> -> !llhd.array<8xi4>
    ...
    %229 = llhd.extract_slice %sel_nodes1, 9 : i16 -> i7
    %230 = llhd.insert_slice %2, %229, 0 : i16, i7
    %231 = llhd.extract_slice %230, 0 : i16 -> i1
    %232 = llhd.extract_slice %sel_nodes1, 10 : i16 -> i6
    ...
    %236 = llhd.sig "sig26" %45 : !llhd.array<16xi4>
    ...
    %242 = llhd.extract_slice %index_nodes1, 9 : !llhd.array<16xi4> -> !llhd.array<7xi4>
    ...
    %247 = llhd.extract_slice %index_nodes1, 10 : !llhd.array<16xi4> -> !llhd.array<6xi4>
    ...
    %256 = llhd.extract_slice %sel_nodes1, 11 : i16 -> i5
    %257 = llhd.insert_slice %2, %256, 0 : i16, i5
    %258 = llhd.extract_slice %257, 0 : i16 -> i1
    %259 = llhd.extract_slice %sel_nodes1, 12 : i16 -> i4
    ...
    %263 = llhd.sig "sig28" %45 : !llhd.array<16xi4>
    ...
    %269 = llhd.extract_slice %index_nodes1, 11 : !llhd.array<16xi4> -> !llhd.array<5xi4>
    ...
    %274 = llhd.extract_slice %index_nodes1, 12 : !llhd.array<16xi4> -> !llhd.array<4xi4>
    ...
    %283 = llhd.extract_slice %sel_nodes1, 13 : i16 -> i3
    %284 = llhd.insert_slice %2, %283, 0 : i16, i3
    %285 = llhd.extract_slice %284, 0 : i16 -> i1
    %286 = llhd.extract_slice %sel_nodes1, 14 : i16 -> i2
    ...
    %290 = llhd.sig "sig30" %45 : !llhd.array<16xi4>
    ...
    %296 = llhd.extract_slice %index_nodes1, 13 : !llhd.array<16xi4> -> !llhd.array<3xi4>
    ...
    %301 = llhd.extract_slice %index_nodes1, 14 : !llhd.array<16xi4> -> !llhd.array<2xi4>
    ...
    %310 = llhd.extract_slice %in_tmp1, 0 : i16 -> i1
    %311 = llhd.extract_slice %in_tmp1, 1 : i16 -> i15
    ...
    %315 = llhd.sig "sig32" %45 : !llhd.array<16xi4>
    ...
    %320 = llhd.extract_element %index_lut1, 0 : !llhd.array<16xi4> -> i4
    %321 = llhd.extract_slice %index_lut1, 1 : !llhd.array<16xi4> -> !llhd.array<15xi4>
    ...
    %329 = llhd.extract_slice %in_tmp1, 2 : i16 -> i14
    %330 = llhd.insert_slice %2, %329, 0 : i16, i14
    %331 = llhd.extract_slice %330, 0 : i16 -> i1
    %332 = llhd.extract_slice %in_tmp1, 3 : i16 -> i13
    ...
    %336 = llhd.sig "sig34" %45 : !llhd.array<16xi4>
    ...
    %341 = llhd.extract_slice %index_lut1, 2 : !llhd.array<16xi4> -> !llhd.array<14xi4>
    %342 = llhd.insert_slice %140, %341, 0 : !llhd.array<16xi4>, !llhd.array<14xi4>
    %343 = llhd.extract_element %342, 0 : !llhd.array<16xi4> -> i4
    %344 = llhd.extract_slice %index_lut1, 3 : !llhd.array<16xi4> -> !llhd.array<13xi4>
    ...
    %352 = llhd.extract_slice %in_tmp1, 4 : i16 -> i12
    %353 = llhd.insert_slice %2, %352, 0 : i16, i12
    %354 = llhd.extract_slice %353, 0 : i16 -> i1
    %355 = llhd.extract_slice %in_tmp1, 5 : i16 -> i11
    ...
    %359 = llhd.sig "sig36" %45 : !llhd.array<16xi4>
    ...
    %364 = llhd.extract_slice %index_lut1, 4 : !llhd.array<16xi4> -> !llhd.array<12xi4>
    %365 = llhd.insert_slice %167, %364, 0 : !llhd.array<16xi4>, !llhd.array<12xi4>
    %366 = llhd.extract_element %365, 0 : !llhd.array<16xi4> -> i4
    %367 = llhd.extract_slice %index_lut1, 5 : !llhd.array<16xi4> -> !llhd.array<11xi4>
    ...
    %375 = llhd.extract_slice %in_tmp1, 6 : i16 -> i10
    %376 = llhd.insert_slice %2, %375, 0 : i16, i10
    %377 = llhd.extract_slice %376, 0 : i16 -> i1
    %378 = llhd.extract_slice %in_tmp1, 7 : i16 -> i9
    ...
    %382 = llhd.sig "sig38" %45 : !llhd.array<16xi4>
    ...
    %387 = llhd.extract_slice %index_lut1, 6 : !llhd.array<16xi4> -> !llhd.array<10xi4>
    %388 = llhd.insert_slice %194, %387, 0 : !llhd.array<16xi4>, !llhd.array<10xi4>
    %389 = llhd.extract_element %388, 0 : !llhd.array<16xi4> -> i4
    %390 = llhd.extract_slice %index_lut1, 7 : !llhd.array<16xi4> -> !llhd.array<9xi4>
    ...
    %398 = llhd.extract_slice %in_tmp1, 8 : i16 -> i8
    %399 = llhd.insert_slice %2, %398, 0 : i16, i8
    %400 = llhd.extract_slice %399, 0 : i16 -> i1
    %401 = llhd.extract_slice %in_tmp1, 9 : i16 -> i7
    ...
    %405 = llhd.sig "sig40" %45 : !llhd.array<16xi4>
    ...
    %410 = llhd.extract_slice %index_lut1, 8 : !llhd.array<16xi4> -> !llhd.array<8xi4>
    %411 = llhd.insert_slice %221, %410, 0 : !llhd.array<16xi4>, !llhd.array<8xi4>
    %412 = llhd.extract_element %411, 0 : !llhd.array<16xi4> -> i4
    %413 = llhd.extract_slice %index_lut1, 9 : !llhd.array<16xi4> -> !llhd.array<7xi4>
    ...
    %421 = llhd.extract_slice %in_tmp1, 10 : i16 -> i6
    %422 = llhd.insert_slice %2, %421, 0 : i16, i6
    %423 = llhd.extract_slice %422, 0 : i16 -> i1
    %424 = llhd.extract_slice %in_tmp1, 11 : i16 -> i5
    ...
    %428 = llhd.sig "sig42" %45 : !llhd.array<16xi4>
    ...
    %433 = llhd.extract_slice %index_lut1, 10 : !llhd.array<16xi4> -> !llhd.array<6xi4>
    %434 = llhd.insert_slice %248, %433, 0 : !llhd.array<16xi4>, !llhd.array<6xi4>
    %435 = llhd.extract_element %434, 0 : !llhd.array<16xi4> -> i4
    %436 = llhd.extract_slice %index_lut1, 11 : !llhd.array<16xi4> -> !llhd.array<5xi4>
    ...
    %444 = llhd.extract_slice %in_tmp1, 12 : i16 -> i4
    %445 = llhd.insert_slice %2, %444, 0 : i16, i4
    %446 = llhd.extract_slice %445, 0 : i16 -> i1
    %447 = llhd.extract_slice %in_tmp1, 13 : i16 -> i3
    ...
    %451 = llhd.sig "sig44" %45 : !llhd.array<16xi4>
    ...
    %456 = llhd.extract_slice %index_lut1, 12 : !llhd.array<16xi4> -> !llhd.array<4xi4>
    %457 = llhd.insert_slice %275, %456, 0 : !llhd.array<16xi4>, !llhd.array<4xi4>
    %458 = llhd.extract_element %457, 0 : !llhd.array<16xi4> -> i4
    %459 = llhd.extract_slice %index_lut1, 13 : !llhd.array<16xi4> -> !llhd.array<3xi4>
    ...
    %467 = llhd.extract_slice %in_tmp1, 14 : i16 -> i2
    %468 = llhd.insert_slice %2, %467, 0 : i16, i2
    %469 = llhd.extract_slice %468, 0 : i16 -> i1
    %470 = llhd.extract_slice %in_tmp1, 15 : i16 -> i1
    ...
    %474 = llhd.sig "sig46" %45 : !llhd.array<16xi4>
    ...
    %479 = llhd.extract_slice %index_lut1, 14 : !llhd.array<16xi4> -> !llhd.array<2xi4>
    ...
    %483 = llhd.extract_slice %index_lut1, 15 : !llhd.array<16xi4> -> !llhd.array<1xi4>
