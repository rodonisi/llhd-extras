llhd.entity @binary_to_gray_param3 (%arg0 : !llhd.sig<i20>) -> (%arg1 : !llhd.sig<i20>) {
  ...
  %2 = llhd.extract_slice %1, 1 : i20 -> i19
  %3 = llhd.insert_slice %c0_i20, %2, 0 : i20, i19
  %4 = llhd.xor %1, %3 : i20
...
llhd.entity @gray_to_binary_param5 (%arg0 : !llhd.sig<i20>) -> (%arg1 : !llhd.sig<i20>) {
  %0 = llhd.const #llhd.time<0s, 0d, 1e> : !llhd.time
  %c0_i20 = constant 0 : i20
  %2 = llhd.extract_slice %arg1, 0 : !llhd.sig<i20> -> !llhd.sig<i1>
  %3 = llhd.prb %arg0 : !llhd.sig<i20>
  %4 = llhd.extract_slice %3, 0 : i20 -> i1
  %5 = llhd.extract_slice %3, 1 : i20 -> i1
  %6 = llhd.extract_slice %3, 2 : i20 -> i1
  %7 = llhd.extract_slice %3, 3 : i20 -> i1
  %8 = llhd.extract_slice %3, 4 : i20 -> i1
  %9 = llhd.extract_slice %3, 5 : i20 -> i1
  %10 = llhd.extract_slice %3, 6 : i20 -> i1
  %11 = llhd.extract_slice %3, 7 : i20 -> i1
  %12 = llhd.extract_slice %3, 8 : i20 -> i1
  %13 = llhd.extract_slice %3, 9 : i20 -> i1
  %14 = llhd.extract_slice %3, 10 : i20 -> i1
  %15 = llhd.extract_slice %3, 11 : i20 -> i1
  %16 = llhd.extract_slice %3, 12 : i20 -> i1
  %17 = llhd.extract_slice %3, 13 : i20 -> i1
  %18 = llhd.extract_slice %3, 14 : i20 -> i1
  %19 = llhd.extract_slice %3, 15 : i20 -> i1
  %20 = llhd.extract_slice %3, 16 : i20 -> i1
  %21 = llhd.extract_slice %3, 17 : i20 -> i1
  %22 = llhd.extract_slice %3, 18 : i20 -> i1
  %23 = llhd.extract_slice %3, 19 : i20 -> i1
  ...
  %43 = llhd.extract_slice %arg1, 1 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %43, %41 after %0 : !llhd.sig<i1>
  %44 = llhd.extract_slice %arg1, 2 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %44, %40 after %0 : !llhd.sig<i1>
  %45 = llhd.extract_slice %arg1, 3 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %45, %39 after %0 : !llhd.sig<i1>
  %46 = llhd.extract_slice %arg1, 4 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %46, %38 after %0 : !llhd.sig<i1>
  %47 = llhd.extract_slice %arg1, 5 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %47, %37 after %0 : !llhd.sig<i1>
  %48 = llhd.extract_slice %arg1, 6 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %48, %36 after %0 : !llhd.sig<i1>
  %49 = llhd.extract_slice %arg1, 7 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %49, %35 after %0 : !llhd.sig<i1>
  %50 = llhd.extract_slice %arg1, 8 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %50, %34 after %0 : !llhd.sig<i1>
  %51 = llhd.extract_slice %arg1, 9 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %51, %33 after %0 : !llhd.sig<i1>
  %52 = llhd.extract_slice %arg1, 10 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %52, %32 after %0 : !llhd.sig<i1>
  %53 = llhd.extract_slice %arg1, 11 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %53, %31 after %0 : !llhd.sig<i1>
  %54 = llhd.extract_slice %arg1, 12 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %54, %30 after %0 : !llhd.sig<i1>
  %55 = llhd.extract_slice %arg1, 13 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %55, %29 after %0 : !llhd.sig<i1>
  %56 = llhd.extract_slice %arg1, 14 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %56, %28 after %0 : !llhd.sig<i1>
  %57 = llhd.extract_slice %arg1, 15 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %57, %27 after %0 : !llhd.sig<i1>
  %58 = llhd.extract_slice %arg1, 16 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %58, %26 after %0 : !llhd.sig<i1>
  %59 = llhd.extract_slice %arg1, 17 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %59, %25 after %0 : !llhd.sig<i1>
  %60 = llhd.extract_slice %arg1, 18 : !llhd.sig<i20> -> !llhd.sig<i1>
  llhd.drv %60, %24 after %0 : !llhd.sig<i1>
  %61 = llhd.extract_slice %arg1, 19 : !llhd.sig<i20> -> !llhd.sig<i1>
...
^loop_body1:
    ...
    %zext1 = llhd.insert_slice %8, %i_ld3, 0 : i32, i21
...
^loop_body2:
    ...
    %zext = llhd.insert_slice %11, %i_ld, 0 : i32, i21
...
^loop_continue1:
    ...
    %15 = llhd.extract_slice %i_ld1, 0 : i21 -> i20
...
^loop_continue2:
    ...
    %zext2 = llhd.insert_slice %8, %i_ld4, 0 : i32, i21
    %21 = subi %9, %zext2 : i32
    %22 = constant 1 : i32
    %23 = subi %21, %22 : i32
    %24 = llhd.extract_slice %23, 0 : i32 -> i20
