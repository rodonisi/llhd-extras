llhd.proc @fifo_v3.param1.always_comb.626.1(%read_pointer_q: !llhd.sig<i4>, %write_pointer_q: !llhd.sig<i4>, %status_cnt_q: !llhd.sig<i5>, %mem_q: !llhd.sig<vector<16xi32>>, %full_o: !llhd.sig<i1>, %empty_o: !llhd.sig<i1>, %data_i: !llhd.sig<i32>, %push_i: !llhd.sig<i1>, %pop_i: !llhd.sig<i1>) -> (%gate_clock: !llhd.sig<i1> , %read_pointer_n: !llhd.sig<i4> , %write_pointer_n: !llhd.sig<i4> , %status_cnt_n: !llhd.sig<i5> , %mem_n: !llhd.sig<vector<16xi32>> , %data_o: !llhd.sig<i32> ) {
    br ^body
^body:
    ...
    %mem_q1 = llhd.prb %mem_q : !llhd.sig<vector<16xi32>>
    %1 = constant 0 : i32
    %2 = llhd.univec %1 : i32 -> vector<16xi32>
    %3 = llhd.shr %mem_q1, %2, %read_pointer_q1 : (vector<16xi32>, vector<16xi32>, i4) -> vector<16xi32>
    %4 = llhd.extf %3, 0 : vector<16xi32> -> i32
    %5 = llhd.vec %4, %data_i1 : vector<2xi32>
    %6 = llhd.extf %5, 0 : vector<2xi32> -> i32
    llhd.drv %data_o, %6 after %0 : !llhd.sig<i32>
    llhd.drv %mem_n, %mem_q1 after %0 : !llhd.sig<vector<16xi32>>
    %7 = constant 1 : i1
    ...
    %16 = constant 1 : i32
    %17 = llhd.inss %1, %status_cnt_q1, 0 : i32, i5
...
^if_true:
    %23 = llhd.dextf %mem_n, %write_pointer_q1 : (!llhd.sig<vector<16xi32>>, i4) -> !llhd.sig<i32>
    llhd.drv %23, %data_i1 after %0 : !llhd.sig<i32>
    llhd.drv %gate_clock, %8 after %0 : !llhd.sig<i1>
    %24 = llhd.inss %1, %write_pointer_q1, 0 : i32, i4
    %25 = llhd.vec %1, %15 : vector<2xi32>
    %26 = llhd.extf %25, 0 : vector<2xi32> -> i32
    %27 = llhd.inss %26, %14, 0 : i32, i4
    %28 = subi %27, %16 : i32
...
^if_true2:
    ...
    %39 = llhd.inss %1, %read_pointer_n1, 0 : i32, i4
    %40 = llhd.vec %1, %15 : vector<2xi32>
    %41 = llhd.extf %40, 0 : vector<2xi32> -> i32
    %42 = llhd.inss %41, %14, 0 : i32, i4
    %43 = subi %42, %16 : i32
...
^if_exit2:
    %46 = addi %17, %16 : i32
    %47 = llhd.exts %46, 0 : i32 -> i5
    llhd.drv %status_cnt_n, %47 after %0 : !llhd.sig<i5>
    br ^if_exit
^if_false1:
    %48 = llhd.inss %1, %read_pointer_q1, 0 : i32, i4
    %49 = addi %48, %16 : i32
    %50 = llhd.exts %49, 0 : i32 -> i4
...
^if_true3:
    ...
    br ^if_exit4
^if_exit3:
    llhd.wait (%read_pointer_q, %write_pointer_q, %status_cnt_q, %mem_q, %full_o, %empty_o, %data_i, %push_i, %pop_i : !llhd.sig<i4>, !llhd.sig<i4>, !llhd.sig<i5>, !llhd.sig<vector<16xi32>>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i32>, !llhd.sig<i1>, !llhd.sig<i1>), ^body
^if_true4:
    llhd.drv %status_cnt_n, %status_cnt_q1 after %0 : !llhd.sig<i5>
    br ^if_exit3
^if_exit4:
    %51 = subi %17, %16 : i32
    %52 = llhd.exts %51, 0 : i32 -> i5
...
llhd.proc @fifo_v3.param1.always_ff.789.1(%gate_clock: !llhd.sig<i1>, %mem_n: !llhd.sig<vector<16xi32>>, %clk_i: !llhd.sig<i1>, %rst_ni: !llhd.sig<i1>) -> (%mem_q: !llhd.sig<vector<16xi32>> ) {
    br ^init
^init:
    %clk_i1 = llhd.prb %clk_i : !llhd.sig<i1>
    %rst_ni1 = llhd.prb %rst_ni : !llhd.sig<i1>
...
^if_true:
    %11 = constant 0 : i32
    %12 = llhd.vec %11, %11, %11, %11, %11, %11, %11, %11, %11, %11, %11, %11, %11, %11, %11, %11 : vector<16xi32>
    llhd.drv %mem_q, %12 after %7 : !llhd.sig<vector<16xi32>>
    br ^init
^if_true1:
    %mem_n1 = llhd.prb %mem_n : !llhd.sig<vector<16xi32>>
    llhd.drv %mem_q, %mem_n1 after %7 : !llhd.sig<vector<16xi32>>
    br ^init
}
...
llhd.entity @fifo_v3.param1(%clk_i: !llhd.sig<i1>, %rst_ni: !llhd.sig<i1>, %flush_i: !llhd.sig<i1>, %testmode_i: !llhd.sig<i1>, %data_i: !llhd.sig<i32>, %push_i: !llhd.sig<i1>, %pop_i: !llhd.sig<i1>) -> (%full_o: !llhd.sig<i1> , %empty_o: !llhd.sig<i1> , %usage_o: !llhd.sig<i4> , %data_o: !llhd.sig<i32> ) {
    ...
    %3 = constant 0 : i32
    %4 = llhd.vec %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3 : vector<16xi32>
    %mem_n = llhd.sig "sig7" %4 : vector<16xi32>
    %mem_q = llhd.sig "sig8" %4 : vector<16xi32>
    %status_cnt_q1 = llhd.prb %status_cnt_q : !llhd.sig<i5>
    %5 = llhd.exts %status_cnt_q1, 0 : i5 -> i4
    ...
    llhd.inst "inst2" @fifo_v3.param1.always_ff.789.1(%gate_clock, %mem_n, %clk_i, %rst_ni) -> (%mem_q) : (!llhd.sig<i1>, !llhd.sig<vector<16xi32>>, !llhd.sig<i1>, !llhd.sig<i1>) -> (!llhd.sig<vector<16xi32>>)
