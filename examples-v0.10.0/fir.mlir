...
llhd.proc @fir.param1.always_ff.260.12(%CLK: !llhd.sig<i1>, %add_out: !llhd.sig<!llhd.array<4xi16>>) -> (%q: !llhd.sig<!llhd.array<4xi16>> ) {
    br ^init
^init:
    %CLK.prb = llhd.prb %CLK : !llhd.sig<i1>
    llhd.wait (%CLK : !llhd.sig<i1>), ^check
...
llhd.entity @fir.param1(%CLK: !llhd.sig<i1>, %X: !llhd.sig<i8>, %W: !llhd.sig<!llhd.array<4xi8>>) -> (%Y: !llhd.sig<i16> ) {
    ...
    llhd.inst "inst1" @fir.param1.always_ff.260.11(%CLK, %add_out) -> (%q) : (!llhd.sig<i1>, !llhd.sig<!llhd.array<4xi16>>) -> (!llhd.sig<!llhd.array<4xi16>>)
    llhd.inst "inst2" @fir.param1.always_ff.260.12(%CLK, %add_out) -> (%q) : (!llhd.sig<i1>, !llhd.sig<!llhd.array<4xi16>>) -> (!llhd.sig<!llhd.array<4xi16>>)
}
...
^0:
    ...
    br ^loop_body(%3, %3 : i32, i32)
^loop_body(%4: i32, %5: i32):
    %6 = llhd.const 0 : i32
    %7 = llhd.neq %4, %6 : i32
    cond_br %7, ^loop_continue, ^loop_exit
^8:
    br ^loop_body(%4, %5 : i32, i32)
^loop_exit:
    llhd.halt
^loop_continue:
    %9 = llhd.const 1 : i1
    %10 = llhd.const #llhd.time<1ns, 0d, 0e> : !llhd.time
    llhd.drv %CLK, %9 after %10 : !llhd.sig<i1>
    %11 = llhd.const 0 : i1
    %12 = llhd.const #llhd.time<2ns, 0d, 0e> : !llhd.time
    llhd.drv %CLK, %11 after %12 : !llhd.sig<i1>
    llhd.wait  for %12, ^8
}
...
^event:
    %3 = llhd.const 0 : i32
    %X.prb = llhd.prb %X : !llhd.sig<i8>
    %zext = llhd.insert_slice %3, %X.prb, 0 : i32, i8
    %4 = llhd.const 9 : i32
    %5 = addi %zext, %4 : i32
    %6 = llhd.const 19 : i32
    %7 = remi_unsigned %5, %6 : i32
    %8 = llhd.extract_slice %7, 0 : i32 -> i8
    %9 = llhd.const #llhd.time<500ps, 0d, 0e> : !llhd.time
    llhd.drv %X, %8 after %9 : !llhd.sig<i8>
    br ^init
}
...
llhd.entity @fir_tb() -> () {
    ...
    %CLK.prb = llhd.prb %CLK : !llhd.sig<i1>
    %23 = llhd.sig "23" %0 : i1
    llhd.drv %23, %CLK.prb after %6 : !llhd.sig<i1>
    %X.prb = llhd.prb %X : !llhd.sig<i8>
    %24 = llhd.sig "24" %1 : i8
    llhd.drv %24, %X.prb after %6 : !llhd.sig<i8>
    %W.prb = llhd.prb %W : !llhd.sig<!llhd.array<4xi8>>
    %25 = llhd.sig "25" %8 : !llhd.array<4xi8>
    llhd.drv %25, %W.prb after %6 : !llhd.sig<!llhd.array<4xi8>>
