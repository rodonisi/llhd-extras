llhd.proc @delta_counter.param5.always_comb.1234.5(%clear_i: !llhd.sig<i1>, %en_i: !llhd.sig<i1>, %load_i: !llhd.sig<i1>, %down_i: !llhd.sig<i1>, %delta_i: !llhd.sig<i4>, %d_i: !llhd.sig<i4>, %counter_q: !llhd.sig<i5>) -> (%counter_d: !llhd.sig<i5> ) {
    br ^body
^body:
...
llhd.proc @delta_counter.param5.always_ff.1273.5(%clk_i: !llhd.sig<i1>, %rst_ni: !llhd.sig<i1>, %counter_d: !llhd.sig<i5>) -> (%counter_q: !llhd.sig<i5> ) {
    br ^init
^init:
...
llhd.entity @delta_counter.param5(%clk_i: !llhd.sig<i1>, %rst_ni: !llhd.sig<i1>, %clear_i: !llhd.sig<i1>, %en_i: !llhd.sig<i1>, %load_i: !llhd.sig<i1>, %down_i: !llhd.sig<i1>, %delta_i: !llhd.sig<i4>, %d_i: !llhd.sig<i4>) -> (%q_o: !llhd.sig<i4> , %overflow_o: !llhd.sig<i1> ) {
    %0 = llhd.const 0 : i5
    ...
    llhd.inst "inst" @delta_counter.param5.always_comb.1234.5(%clear_i, %en_i, %load_i, %down_i, %delta_i, %d_i, %counter_q) -> (%counter_d) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i4>, !llhd.sig<i4>, !llhd.sig<i5>) -> (!llhd.sig<i5>)
    llhd.inst "inst1" @delta_counter.param5.always_ff.1273.5(%clk_i, %rst_ni, %counter_d) -> (%counter_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i5>) -> (!llhd.sig<i5>)
}

llhd.entity @counter.param3(%clk_i: !llhd.sig<i1>, %rst_ni: !llhd.sig<i1>, %clear_i: !llhd.sig<i1>, %en_i: !llhd.sig<i1>, %load_i: !llhd.sig<i1>, %down_i: !llhd.sig<i1>, %d_i: !llhd.sig<i4>) -> (%q_o: !llhd.sig<i4> , %overflow_o: !llhd.sig<i1> ) {
    %clk_i.prb = llhd.prb %clk_i : !llhd.sig<i1>
    %0 = llhd.const 0 : i1
    %1 = llhd.sig "1" %0 : i1
    %2 = llhd.const #llhd.time<0s, 0d, 1e> : !llhd.time
    llhd.drv %1, %clk_i.prb after %2 : !llhd.sig<i1>
    %rst_ni.prb = llhd.prb %rst_ni : !llhd.sig<i1>
    %3 = llhd.sig "3" %0 : i1
    llhd.drv %3, %rst_ni.prb after %2 : !llhd.sig<i1>
    %clear_i.prb = llhd.prb %clear_i : !llhd.sig<i1>
    %4 = llhd.sig "4" %0 : i1
    llhd.drv %4, %clear_i.prb after %2 : !llhd.sig<i1>
    %en_i.prb = llhd.prb %en_i : !llhd.sig<i1>
    %5 = llhd.sig "5" %0 : i1
    llhd.drv %5, %en_i.prb after %2 : !llhd.sig<i1>
    %load_i.prb = llhd.prb %load_i : !llhd.sig<i1>
    %6 = llhd.sig "6" %0 : i1
    llhd.drv %6, %load_i.prb after %2 : !llhd.sig<i1>
    %down_i.prb = llhd.prb %down_i : !llhd.sig<i1>
    %7 = llhd.sig "7" %0 : i1
    llhd.drv %7, %down_i.prb after %2 : !llhd.sig<i1>
    %8 = llhd.const 1 : i4
    %9 = llhd.const 0 : i4
    %10 = llhd.sig "10" %9 : i4
    ...
    %d_i.prb = llhd.prb %d_i : !llhd.sig<i4>
    %11 = llhd.sig "11" %9 : i4
    llhd.drv %11, %d_i.prb after %2 : !llhd.sig<i4>
    llhd.inst "inst" @delta_counter.param5(%1, %3, %4, %5, %6, %7, %10, %11) -> (%q_o, %overflow_o) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i4>, !llhd.sig<i4>) -> (!llhd.sig<i4>, !llhd.sig<i1>)
}

llhd.proc @lfsr_16bit.param7.always_comb.1433.7(%en_i: !llhd.sig<i1>, %shift_q: !llhd.sig<i16>) -> (%out_o: !llhd.sig<i16> , %shift_d: !llhd.sig<i16> ) {
    br ^body
^body:
...
llhd.proc @lfsr_16bit.param7.always_ff.1474.7(%clk_i: !llhd.sig<i1>, %rst_ni: !llhd.sig<i1>, %shift_d: !llhd.sig<i16>) -> (%shift_q: !llhd.sig<i16> ) {
    br ^init
^init:
    %clk_i.prb = llhd.prb %clk_i : !llhd.sig<i1>
    %rst_ni.prb = llhd.prb %rst_ni : !llhd.sig<i1>
...
llhd.proc @lfsr_16bit.param7.initial.1492.7() -> () {
    br ^0
^0:
    llhd.halt
}

llhd.entity @lfsr_16bit.param7(%clk_i: !llhd.sig<i1>, %rst_ni: !llhd.sig<i1>, %en_i: !llhd.sig<i1>) -> (%out_o: !llhd.sig<i16> ) {
    %0 = llhd.const 0 : i16
    %shift_d = llhd.sig "shift_d" %0 : i16
    %shift_q = llhd.sig "shift_q" %0 : i16
    llhd.inst "inst" @lfsr_16bit.param7.always_comb.1433.7(%en_i, %shift_q) -> (%out_o, %shift_d) : (!llhd.sig<i1>, !llhd.sig<i16>) -> (!llhd.sig<i16>, !llhd.sig<i16>)
    llhd.inst "inst1" @lfsr_16bit.param7.always_ff.1474.7(%clk_i, %rst_ni, %shift_d) -> (%shift_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i16>) -> (!llhd.sig<i16>)
    llhd.inst "inst2" @lfsr_16bit.param7.initial.1492.7() -> () : () -> ()
}
...
llhd.entity @stream_delay.param1(%clk_i: !llhd.sig<i1>, %rst_ni: !llhd.sig<i1>, %payload_i: !llhd.sig<i32>, %valid_i: !llhd.sig<i1>, %ready_i: !llhd.sig<i1>) -> (%ready_o: !llhd.sig<i1> , %payload_o: !llhd.sig<i32> , %valid_o: !llhd.sig<i1> ) {
    ...
    %clk_i.prb = llhd.prb %clk_i : !llhd.sig<i1>
    %4 = llhd.sig "4" %1 : i1
    llhd.drv %4, %clk_i.prb after %3 : !llhd.sig<i1>
    %rst_ni.prb = llhd.prb %rst_ni : !llhd.sig<i1>
    %5 = llhd.sig "5" %1 : i1
    llhd.drv %5, %rst_ni.prb after %3 : !llhd.sig<i1>
    %6 = llhd.sig "6" %1 : i1
    llhd.drv %6, %1 after %3 : !llhd.sig<i1>
    %en.prb = llhd.prb %en : !llhd.sig<i1>
    %7 = llhd.sig "7" %1 : i1
    llhd.drv %7, %en.prb after %3 : !llhd.sig<i1>
    %load.prb = llhd.prb %load : !llhd.sig<i1>
    %8 = llhd.sig "8" %1 : i1
    llhd.drv %8, %load.prb after %3 : !llhd.sig<i1>
    %9 = llhd.const 1 : i1
    %10 = llhd.sig "10" %1 : i1
    llhd.drv %10, %9 after %3 : !llhd.sig<i1>
    %counter_load.prb = llhd.prb %counter_load : !llhd.sig<i4>
    %11 = llhd.sig "11" %2 : i4
    llhd.drv %11, %counter_load.prb after %3 : !llhd.sig<i4>
    %i_counter.overflow_o.default = llhd.sig "i_counter.overflow_o.default" %1 : i1
    llhd.inst "inst" @counter.param3(%4, %5, %6, %7, %8, %10, %11) -> (%count_out, %i_counter.overflow_o.default) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i4>) -> (!llhd.sig<i4>, !llhd.sig<i1>)
    %12 = llhd.const 0 : i16
    %lfsr_out = llhd.sig "lfsr_out" %12 : i16
    %lfsr_out.prb = llhd.prb %lfsr_out : !llhd.sig<i16>
    %13 = llhd.extract_slice %lfsr_out.prb, 0 : i16 -> i4
    llhd.drv %counter_load, %13 after %3 : !llhd.sig<i4>
    %14 = llhd.sig "14" %1 : i1
    llhd.drv %14, %clk_i.prb after %3 : !llhd.sig<i1>
    %15 = llhd.sig "15" %1 : i1
    llhd.drv %15, %rst_ni.prb after %3 : !llhd.sig<i1>
    %16 = llhd.sig "16" %1 : i1
    llhd.drv %16, %load.prb after %3 : !llhd.sig<i1>
    llhd.inst "inst1" @lfsr_16bit.param7(%14, %15, %16) -> (%lfsr_out) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i1>) -> (!llhd.sig<i16>)
...
llhd.entity @stream_delay_tb() -> () {
    ...
    %payload_i.prb = llhd.prb %payload_i : !llhd.sig<i32>
    %6 = llhd.sig "6" %2 : i32
    llhd.drv %6, %payload_i.prb after %3 : !llhd.sig<i32>
    %valid_i.prb = llhd.prb %valid_i : !llhd.sig<i1>
    %7 = llhd.sig "7" %0 : i1
    llhd.drv %7, %valid_i.prb after %3 : !llhd.sig<i1>
    %ready_i.prb = llhd.prb %ready_i : !llhd.sig<i1>
    %8 = llhd.sig "8" %0 : i1
    llhd.drv %8, %ready_i.prb after %3 : !llhd.sig<i1>
