...
llhd.entity @binary_to_gray.param5(%A: !llhd.sig<i4>) -> (%Z: !llhd.sig<i4> ) {
    %A.prb = llhd.prb %A : !llhd.sig<i4>
    %0 = llhd.extract_slice %A.prb, 1 : i4 -> i3
    %1 = llhd.const 0 : i4
    %2 = llhd.insert_slice %1, %0, 0 : i4, i3
...
llhd.entity @gray_to_binary.param7(%A: !llhd.sig<i4>) -> (%Z: !llhd.sig<i4> ) {
...
llhd.proc @cdc_fifo_gray.param1.always_ff.265.1(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<32xi8>> ) {
    br ^init
^init:
...
^event:
    ...
    %6 = llhd.not %5 : i1
    %7 = llhd.neq %6, %0 : i1
    %8 = llhd.extract_element %fifo_data_q, 0 : !llhd.sig<!llhd.array<32xi8>> -> !llhd.sig<i8>
    %9 = llhd.const #llhd.time<0s, 1d, 0e> : !llhd.time
    cond_br %7, ^if_true, ^if_false
^if_false:
    %fifo_write.prb = llhd.prb %fifo_write : !llhd.sig<i1>
    %10 = llhd.neq %fifo_write.prb, %0 : i1
    %11 = llhd.const 0 : i32
    %fifo_widx.prb = llhd.prb %fifo_widx : !llhd.sig<i3>
    %zext = llhd.insert_slice %11, %fifo_widx.prb, 0 : i32, i3
    %12 = llhd.eq %zext, %11 : i32
    %13 = llhd.neq %12, %0 : i1
...
^if_true:
    %16 = llhd.const 0 : i8
    llhd.drv %8, %16 after %9 : !llhd.sig<i8>
    br ^init
^if_true1:
    %fifo_wdata.prb = llhd.prb %fifo_wdata : !llhd.sig<i32>
    %17 = llhd.extract_slice %fifo_wdata.prb, 0 : i32 -> i8
    llhd.drv %8, %17 after %9 : !llhd.sig<i8>
    br ^init
}

llhd.proc @cdc_fifo_gray.param1.always_ff.265.19(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<32xi8>> ) {
    br ^init
^init:
    %src_clk_i.prb = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni.prb = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
^if_false:
    ...
    %12 = llhd.const 0 : i32
    %fifo_widx.prb = llhd.prb %fifo_widx : !llhd.sig<i3>
    %zext = llhd.insert_slice %12, %fifo_widx.prb, 0 : i32, i3
    %13 = llhd.eq %zext, %8 : i32
    %14 = llhd.neq %13, %0 : i1
    %15 = llhd.and %11, %14 : i1
    %16 = llhd.neq %15, %0 : i1
    cond_br %16, ^if_true1, ^init
^if_true:
    %17 = llhd.array_uniform %9 : !llhd.array<32xi8>
    %18 = llhd.dyn_extract_element %fifo_data_q, %8 : (!llhd.sig<!llhd.array<32xi8>>, i32) -> !llhd.sig<i8>
    llhd.drv %18, %9 after %10 : !llhd.sig<i8>
    br ^init
^if_true1:
    %19 = llhd.array_uniform %9 : !llhd.array<32xi8>
    %20 = llhd.dyn_extract_element %fifo_data_q, %8 : (!llhd.sig<!llhd.array<32xi8>>, i32) -> !llhd.sig<i8>
    %fifo_wdata.prb = llhd.prb %fifo_wdata : !llhd.sig<i32>
    %21 = llhd.extract_slice %fifo_wdata.prb, 0 : i32 -> i8
    llhd.drv %20, %21 after %10 : !llhd.sig<i8>
    br ^init
}

llhd.proc @cdc_fifo_gray.param1.always_ff.265.20(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<32xi8>> ) {
    br ^init
^init:
    %src_clk_i.prb = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni.prb = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
llhd.proc @cdc_fifo_gray.param1.always_ff.265.21(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<32xi8>> ) {
    br ^init
^init:
    %src_clk_i.prb = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni.prb = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
llhd.proc @cdc_fifo_gray.param1.always_ff.265.22(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<32xi8>> ) {
    br ^init
^init:
    %src_clk_i.prb = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni.prb = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
llhd.proc @cdc_fifo_gray.param1.always_ff.265.23(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<32xi8>> ) {
    br ^init
^init:
    %src_clk_i.prb = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni.prb = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
llhd.proc @cdc_fifo_gray.param1.always_ff.265.24(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<32xi8>> ) {
    br ^init
^init:
    %src_clk_i.prb = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni.prb = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
llhd.proc @cdc_fifo_gray.param1.always_ff.265.25(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %fifo_widx: !llhd.sig<i3>, %fifo_write: !llhd.sig<i1>, %fifo_wdata: !llhd.sig<i32>) -> (%fifo_data_q: !llhd.sig<!llhd.array<32xi8>> ) {
    br ^init
^init:
    %src_clk_i.prb = llhd.prb %src_clk_i : !llhd.sig<i1>
    %src_rst_ni.prb = llhd.prb %src_rst_ni : !llhd.sig<i1>
...
^if_false:
    ...
    llhd.drv %src_rptr_gray_q, %dst_rptr_gray_q.prb after %8 : !llhd.sig<i4>
    %src_rptr_gray_q.prb = llhd.prb %src_rptr_gray_q : !llhd.sig<i4>
    llhd.drv %src_rptr_gray_q2, %src_rptr_gray_q.prb after %8 : !llhd.sig<i4>
    br ^init
^if_true:
    %9 = llhd.const 0 : i4
...
^if_false:
    ...
    llhd.drv %dst_wptr_gray_q, %src_wptr_gray_q.prb after %8 : !llhd.sig<i4>
    %dst_wptr_gray_q.prb = llhd.prb %dst_wptr_gray_q : !llhd.sig<i4>
    llhd.drv %dst_wptr_gray_q2, %dst_wptr_gray_q.prb after %8 : !llhd.sig<i4>
    br ^init
^if_true:
    %9 = llhd.const 0 : i4
...
llhd.entity @cdc_fifo_gray.param1(%src_rst_ni: !llhd.sig<i1>, %src_clk_i: !llhd.sig<i1>, %src_data_i: !llhd.sig<i32>, %src_valid_i: !llhd.sig<i1>, %dst_rst_ni: !llhd.sig<i1>, %dst_clk_i: !llhd.sig<i1>, %dst_ready_i: !llhd.sig<i1>) -> (%src_ready_o: !llhd.sig<i1> , %dst_data_o: !llhd.sig<i32> , %dst_valid_o: !llhd.sig<i1> ) {
    ...
    %3 = llhd.const 0 : i8
    %4 = llhd.array %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3, %3 : !llhd.array<32xi8>
    %fifo_data_q = llhd.sig "fifo_data_q" %4 : !llhd.array<32xi8>
    %5 = llhd.const 0 : i4
    %src_wptr_bin_q = llhd.sig "src_wptr_bin_q" %5 : i4
    %src_wptr_gray_q = llhd.sig "src_wptr_gray_q" %5 : i4
    %dst_rptr_bin_q = llhd.sig "dst_rptr_bin_q" %5 : i4
    %dst_rptr_gray_q = llhd.sig "dst_rptr_gray_q" %5 : i4
    %src_wptr_bin_d = llhd.sig "src_wptr_bin_d" %5 : i4
    %src_wptr_gray_d = llhd.sig "src_wptr_gray_d" %5 : i4
    %dst_rptr_bin_d = llhd.sig "dst_rptr_bin_d" %5 : i4
    %dst_rptr_gray_d = llhd.sig "dst_rptr_gray_d" %5 : i4
    %src_rptr_gray_q = llhd.sig "src_rptr_gray_q" %5 : i4
    %src_rptr_gray_q2 = llhd.sig "src_rptr_gray_q2" %5 : i4
    %dst_wptr_gray_q = llhd.sig "dst_wptr_gray_q" %5 : i4
    %dst_wptr_gray_q2 = llhd.sig "dst_wptr_gray_q2" %5 : i4
    %src_rptr_bin = llhd.sig "src_rptr_bin" %5 : i4
    %dst_wptr_bin = llhd.sig "dst_wptr_bin" %5 : i4
    %fifo_data_q.prb = llhd.prb %fifo_data_q : !llhd.sig<!llhd.array<32xi8>>
    %fifo_ridx.prb = llhd.prb %fifo_ridx : !llhd.sig<i3>
    %6 = llhd.array_uniform %3 : !llhd.array<32xi8>
    %7 = llhd.shr %fifo_data_q.prb, %6, %fifo_ridx.prb : (!llhd.array<32xi8>, !llhd.array<32xi8>, i3) -> !llhd.array<32xi8>
    %8 = llhd.extract_element %7, 0 : !llhd.array<32xi8> -> i8
    %zext = llhd.insert_slice %2, %8, 0 : i32, i8
    %9 = llhd.const #llhd.time<0s, 0d, 1e> : !llhd.time
    llhd.drv %fifo_rdata, %zext after %9 : !llhd.sig<i32>
    %src_wptr_bin_q.prb = llhd.prb %src_wptr_bin_q : !llhd.sig<i4>
    %zext1 = llhd.insert_slice %2, %src_wptr_bin_q.prb, 0 : i32, i4
    %10 = llhd.const 1 : i32
    %11 = addi %zext1, %10 : i32
    %12 = llhd.extract_slice %11, 0 : i32 -> i4
    llhd.drv %src_wptr_bin_d, %12 after %9 : !llhd.sig<i4>
    %dst_rptr_bin_q.prb = llhd.prb %dst_rptr_bin_q : !llhd.sig<i4>
    %zext2 = llhd.insert_slice %2, %dst_rptr_bin_q.prb, 0 : i32, i4
    %13 = addi %zext2, %10 : i32
    %14 = llhd.extract_slice %13, 0 : i32 -> i4
    llhd.drv %dst_rptr_bin_d, %14 after %9 : !llhd.sig<i4>
    %src_rptr_bin.prb = llhd.prb %src_rptr_bin : !llhd.sig<i4>
    %15 = llhd.xor %src_wptr_bin_q.prb, %src_rptr_bin.prb : i4
    %16 = llhd.const 8 : i4
    %17 = llhd.neq %15, %16 : i4
    llhd.drv %src_ready_o, %17 after %9 : !llhd.sig<i1>
    %dst_wptr_bin.prb = llhd.prb %dst_wptr_bin : !llhd.sig<i4>
    %18 = llhd.xor %dst_rptr_bin_q.prb, %dst_wptr_bin.prb : i4
    %19 = llhd.neq %18, %5 : i4
    llhd.drv %dst_valid_o, %19 after %9 : !llhd.sig<i1>
    %20 = llhd.extract_slice %src_wptr_bin_q.prb, 0 : i4 -> i3
    llhd.drv %fifo_widx, %20 after %9 : !llhd.sig<i3>
    %src_data_i.prb = llhd.prb %src_data_i : !llhd.sig<i32>
    llhd.drv %fifo_wdata, %src_data_i.prb after %9 : !llhd.sig<i32>
    %src_valid_i.prb = llhd.prb %src_valid_i : !llhd.sig<i1>
    %21 = llhd.neq %src_valid_i.prb, %1 : i1
    %src_ready_o.prb = llhd.prb %src_ready_o : !llhd.sig<i1>
    %22 = llhd.neq %src_ready_o.prb, %1 : i1
    %23 = llhd.and %21, %22 : i1
    llhd.drv %fifo_write, %23 after %9 : !llhd.sig<i1>
    %24 = llhd.extract_slice %dst_rptr_bin_q.prb, 0 : i4 -> i3
    llhd.drv %fifo_ridx, %24 after %9 : !llhd.sig<i3>
    %fifo_rdata.prb = llhd.prb %fifo_rdata : !llhd.sig<i32>
    llhd.drv %dst_data_o, %fifo_rdata.prb after %9 : !llhd.sig<i32>
    %src_wptr_bin_d.prb = llhd.prb %src_wptr_bin_d : !llhd.sig<i4>
    %25 = llhd.sig "25" %5 : i4
    llhd.drv %25, %src_wptr_bin_d.prb after %9 : !llhd.sig<i4>
    llhd.inst "inst" @binary_to_gray.param3(%25) -> (%src_wptr_gray_d) : (!llhd.sig<i4>) -> (!llhd.sig<i4>)
    %dst_rptr_bin_d.prb = llhd.prb %dst_rptr_bin_d : !llhd.sig<i4>
    %26 = llhd.sig "26" %5 : i4
    llhd.drv %26, %dst_rptr_bin_d.prb after %9 : !llhd.sig<i4>
    llhd.inst "inst1" @binary_to_gray.param5(%26) -> (%dst_rptr_gray_d) : (!llhd.sig<i4>) -> (!llhd.sig<i4>)
    %src_rptr_gray_q2.prb = llhd.prb %src_rptr_gray_q2 : !llhd.sig<i4>
    %27 = llhd.sig "27" %5 : i4
    llhd.drv %27, %src_rptr_gray_q2.prb after %9 : !llhd.sig<i4>
    llhd.inst "inst2" @gray_to_binary.param7(%27) -> (%src_rptr_bin) : (!llhd.sig<i4>) -> (!llhd.sig<i4>)
    %dst_wptr_gray_q2.prb = llhd.prb %dst_wptr_gray_q2 : !llhd.sig<i4>
    %28 = llhd.sig "28" %5 : i4
    llhd.drv %28, %dst_wptr_gray_q2.prb after %9 : !llhd.sig<i4>
    llhd.inst "inst3" @gray_to_binary.param9(%28) -> (%dst_wptr_bin) : (!llhd.sig<i4>) -> (!llhd.sig<i4>)
    llhd.inst "inst4" @cdc_fifo_gray.param1.always_ff.265.1(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<32xi8>>)
    llhd.inst "inst5" @cdc_fifo_gray.param1.always_ff.265.19(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<32xi8>>)
    llhd.inst "inst6" @cdc_fifo_gray.param1.always_ff.265.20(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<32xi8>>)
    llhd.inst "inst7" @cdc_fifo_gray.param1.always_ff.265.21(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<32xi8>>)
    llhd.inst "inst8" @cdc_fifo_gray.param1.always_ff.265.22(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<32xi8>>)
    llhd.inst "inst9" @cdc_fifo_gray.param1.always_ff.265.23(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<32xi8>>)
    llhd.inst "inst10" @cdc_fifo_gray.param1.always_ff.265.24(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<32xi8>>)
    llhd.inst "inst11" @cdc_fifo_gray.param1.always_ff.265.25(%src_rst_ni, %src_clk_i, %fifo_widx, %fifo_write, %fifo_wdata) -> (%fifo_data_q) : (!llhd.sig<i1>, !llhd.sig<i1>, !llhd.sig<i3>, !llhd.sig<i1>, !llhd.sig<i32>) -> (!llhd.sig<!llhd.array<32xi8>>)
...
^loop_body1:
    %dst_valid_o.prb = llhd.prb %dst_valid_o : !llhd.sig<i1>
    %19 = llhd.const 0 : i1
    %20 = llhd.neq %dst_valid_o.prb, %19 : i1
    %21 = llhd.not %20 : i1
    %22 = llhd.neq %21, %19 : i1
    %23 = llhd.const 1 : i1
...
^loop_exit1:
    ...
    %27 = llhd.neq %i.ld, %dst_data_o.prb : i32
    %zext = llhd.insert_slice %26, %27, 0 : i32, i1
    %ERRORS.prb = llhd.prb %ERRORS : !llhd.sig<i32>
    %28 = addi %ERRORS.prb, %zext : i32
    llhd.drv %ERRORS, %28 after %24 : !llhd.sig<i32>
    llhd.wait  for %25, ^29
^loop_continue:
    llhd.drv %dst_clk_i, %23 after %24 : !llhd.sig<i1>
    llhd.wait  for %25, ^30
